 ...
 * @Description : 목록의 페이지 수를 표시하고 페이지 번호를 누르면 번호와 매핑되어 있는 목록을 호출하도록 링크
 * @Modification Information

 * @author 자바 애플리케이션 개발팀
 * @since 2013. 01.01
 * @version 1.0
 */
public class PagingUtil {
	...
	* @param rowCount : 한 페이지의  게시물의 수
	* @param pageCount : 한 화면에 보여줄 페이지 수
	* @param pageUrl : 호출 페이지 url
	* @param addKey : 부가적인 key 없을 때는 null 처리 (&num=23형식으로 전달할 것)
	*/
	...
	/**
	 * @return pagingHtml : pagination
	 */
	public StringBuffer getPagingHtml() {
		return pagingHtml;
	}
	/**
	 * @return startCount : 목록에 행을 표시할 때 시작 행 번호
	 */
	public int getStartCount() {
		return startCount;
	}
	/**
	 * @return endCount : 목록에 행을 표시할 때 끝 행 번호
	 */
